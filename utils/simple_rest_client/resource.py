...
class BaseResource:
    ...
    def __init__(
        ...
        self.full_action_url = None if full_action_url is None else full_action_url
    ...
    def set_action_full_url(self, url):
        self.full_action_url = url

    def get_action_full_url(self, action_name, *parts):
        action = self.get_action(action_name)
        if self.full_action_url is not None:
            return self.full_action_url
        else:
            try:
