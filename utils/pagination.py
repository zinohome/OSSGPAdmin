...
DISPLAY_MSG = "当前显示第[ {start} ]至[ {end} ]条，共有[ {total} ]条"

SEARCH_MSG = "found <b>{found}</b> {record_name}, \
displaying <b>{start} - {end}</b>"

_bs4 = '<nav aria-label="..." class="justify-content-end"><ul class="pagination {0} {1}">'
_bs5 = '<nav aria-label="..." class="justify-content-end"><ul class="pagination {0} {1}">'
_bs33 = '<nav aria-label="..." class="justify-content-end"><ul class="pagination {0} {1}">'
